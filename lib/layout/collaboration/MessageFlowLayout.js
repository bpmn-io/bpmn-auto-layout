...
import { point, bounds, directConnection, cleanPoints, segmentEntersRect, compareScores, routeLength, toSegments, segmentsProperlyCross } from '../geometry/index.js';
import { visibilityRoute, segmentIsClear, pathIsClear } from '../process/routing/SequenceFlowRouting.js';
...
export function participantOrderingStrategy(participantCount) {
