...
DiFactory.prototype.createBpmnElementDi = function(elementType, attrs, pos) {
  ...
  if (elementType === 'connection') {
    ...
    var waypoints = this._connectRectangles(sourceBounds, targetBounds);
...
DiFactory.prototype._connectRectangles = function(source, target) {
  ...
  return this._connectPoints(start, end, directions);
};

// see documentation bpmn.io/diagram-js/layout/ManhattanLayout
DiFactory._connectPoints = function(a, b, directions) {

  var points = [];

  if (!pointsAligned(a, b)) {
    points = this._getBendpoints(a, b, directions);
  }
...
// see documentation bpmn.io/diagram-js/layout/ManhattanLayout
DiFactory._getBendpoints = function(a, b, directions) {
