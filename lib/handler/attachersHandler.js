...
import {getAttachedOutgoingElements, getOutgoingElements} from "../utils/elementUtils.js";

export default {
  'addToGrid': ({ element, grid, visited, reverse }) => {
    const nextElements = [];

    const attachedOutgoing = !reverse ? getAttachedOutgoingElements(element) : [];

    // handle boundary events
    attachedOutgoing.forEach(nextElement => {
